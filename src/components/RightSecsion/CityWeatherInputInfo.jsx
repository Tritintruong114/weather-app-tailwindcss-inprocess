...
function CityWeatherInputInfo() {
  return (
    <div className="md:flex absolute left-3  top-3 h-fit shadow-xl shadow-gray-700   w-1/5   rounded-3xl   flex flex-col justify-around items-center bg-gradient-to-tr from-gray-100  to-gray-200">
