...
function CityWeatherInputInfo() {
  return (
    <div className="md:flex absolute left-0 top-0 py-3 my-3 mx-16    shadow-xl shadow-gray-700 w-1/4   rounded-3xl   flex flex-col justify-around items-center bg-gradient-to-tr from-gray-100  to-gray-200">
      {/* <h1 className="text-black font-light mt-3">
        This is a Weather App - By Bruno Truong
      </h1> */}

      <div className="md:flex flex flex-row w-3/4 space-x-3 py-3 mt- justify-center items-center">
      ...
      <div className="md:flex flex flex-col justify-center items-center">
        ...
        <h1 className="md:flex font-bold text-6xl text-orange-500 my-3">
          16°C
        </h1>
